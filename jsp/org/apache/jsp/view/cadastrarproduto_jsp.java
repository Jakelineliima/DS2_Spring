...
public final class cadastrarproduto_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t<input type=\"text\" class=\"form-control\" name=\"quantidade\" />\r\n");
      out.write("\t\t\t<br />\r\n");
      out.write("\t\t\t<label for=\"valor\">Valor:</label>\r\n");
      out.write("\t\t\t<input type=\"text\" class=\"form-control\" name=\"valor\" />\r\n");
      out.write("\t\t\t<br />\r\n");
      out.write("\t\t\t<button class=\"btn btn-success\">Cadastrar</button>\r\n");
      out.write("\t\t</form>\r\n");
      out.write("\t</div>\r\n");
